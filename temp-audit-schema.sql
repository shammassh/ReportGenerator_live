...
BEGIN
    ...
    PRINT 'âœ… Created AuditSchemas table';
END
ELSE
    PRINT 'âš ï¸ AuditSchemas table already exists';
GO
...
BEGIN
    ...
    PRINT 'âœ… Created AuditSections table';
END
ELSE
    PRINT 'âš ï¸ AuditSections table already exists';
GO
...
BEGIN
    ...
    PRINT 'âœ… Created AuditItems table';
END
ELSE
    PRINT 'âš ï¸ AuditItems table already exists';
GO
...
END
GO
PRINT 'âœ… Created sp_GetAllSchemas';
GO
...
END
GO
PRINT 'âœ… Created sp_CreateSchema';
GO
...
END
GO
PRINT 'âœ… Created sp_GetSectionsBySchema';
GO
...
END
GO
PRINT 'âœ… Created sp_CreateSection';
GO
...
END
GO
PRINT 'âœ… Created sp_GetItemsBySection';
GO
...
END
GO
PRINT 'âœ… Created sp_CreateItem';
GO
...
END
GO
PRINT 'âœ… Created sp_UpdateItem';
GO
...
END
GO
PRINT 'âœ… Created sp_DeleteItem';
GO
...
END
GO
PRINT 'âœ… Created sp_GetFullSchema';
GO

PRINT '';
PRINT '=====================================================';
PRINT 'âœ… ALL TABLES AND STORED PROCEDURES CREATED!';
PRINT '=====================================================';
PRINT '';
PRINT 'Tables:';
...
PRINT '';
PRINT 'Relationships:';
PRINT '  - Schema (1) â†’ Sections (many)';
PRINT '  - Section (1) â†’ Items (many)';
PRINT '';
GO
